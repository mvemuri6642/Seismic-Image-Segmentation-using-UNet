...
def preprocessing_custom_fun(img):
...
def trainGenerator(batch_size,train_path,image_folder,mask_folder,aug_dict,preprocess_input,image_color_mode = "grayscale",
    ...
    '''
    image_datagen = ImageDataGenerator(**aug_dict,preprocessing_function = preprocessing_custom_fun)
